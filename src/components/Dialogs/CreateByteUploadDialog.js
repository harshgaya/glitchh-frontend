...
import classes from './CreateByteUploadDialog.module.css';
import uploadImage from '../../Assets/popup_box/uploadImage.png';
import { VscAdd } from "react-icons/vsc";
import { VscClose } from "react-icons/vsc";

function CreateByteUploadDialog() {
    ...
    return (
        <div className={classes.CreateByteUploadDialog}>

            <div className={classes.createByteContents}>

                <div className={classes.createByteText}>
                    <p>Create Byte</p>
                    <button>Post</button>
                </div>
...
export default CreateByteUploadDialog